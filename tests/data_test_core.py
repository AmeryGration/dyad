...
delaunay_elements_from_orbital_elements = [
    ...
    [
        [1., 0.5, 0., 1., 0., 0., 1.],
        [0.00804912911741,  0.014897454684145, 0.017202098944262,
         0.              ,  0.               , 0.               ],        
    ],
    [
        [1., 0.5, 2.*np.pi, 1., 0., 0., 1.],
        [0.00804912911741 , 0.014897454684145, 0.017202098944262,
         6.283185307179586, 0.               , 0.               ],        
    ],
    [
        [1., 0.5, 0., 1., 2.*np.pi, 0., 1.],
        [0.00804912911741 , 0.014897454684145, 0.017202098944262,
         0.               , 6.283185307179586, 0.               ]
    ],
    [
        [1., 0.5, 0., 1., 0., 2.*np.pi, 1.],
        [0.00804912911741 , 0.014897454684145, 0.017202098944262,
         0.               , 0.               , 6.283185307179586]
    ],
    [
        [1., 0.5, 2.*np.pi, 1., 2.*np.pi, 0., 1.],
        [0.00804912911741 , 0.014897454684145, 0.017202098944262,
         6.283185307179586, 6.283185307179586, 0.               ]
    ],
    [
        [1., 0.5, 2.*np.pi, 1., 2.*np.pi, 2.*np.pi, 1.],
        [0.00804912911741 , 0.014897454684145, 0.017202098944262,
...
orbital_elements_from_delaunay_elements = [
    ...
    [
        [0.00804912911741 , 0.014897454684145, 0.017202098944262,
         6.283185307179586, 6.283185307179586, 0.               ,
         1.],
        [1., 0.5, 2.*np.pi, 1., 2.*np.pi, 0.],
    ],
    [
        [0.00804912911741 , 0.014897454684145, 0.017202098944262,
         6.283185307179586, 6.283185307179586, 6.283185307179586,
         1.],
        [1., 0.5, 2.*np.pi, 1., 2.*np.pi, 2.*np.pi],
    ]
]
...
modified_delaunay_elements_from_orbital_elements = [
    ...
    [
        [1., 0., 0., 1., 2.*np.pi, 0., 1.],
        [ 0.                ,  0.007907765218906, 0.017202098944262,
    ...
    [
        ...
        [  0.               ,  0.               ,  0.017202098944262,
         -12.566370614359172, -6.283185307179586, 12.566370614359172]
    ],
    [
    ...
    [
        [1., 0.5, 0., 0., 0., 0., 1.],
        [ 0.002304644260118,  0.                , 0.017202098944262,
          -0.              , -0.                , 0.               ]
    ],
    [
        [1., 0.5, 2.*np.pi, 0., 0., 0., 1.],
        [ 2.304644260117695e-03,  0.000000000000000e+00, 1.720209894426244e-02,
        -6.283185307179586e+00, -6.283185307179586e+00, 6.283185307179586e+00]
    ],
    [
        [1., 0.5, 0., 1., 2.*np.pi, 0., 1.],
        [ 2.304644260117695e-03,  6.848325566735219e-03, 1.720209894426244e-02,
...
orbital_elements_from_modified_delaunay_elements = [
    ...
    [
        [ 2.304644260117695e-03,  0.000000000000000e+00, 1.720209894426244e-02,
         -1.256637061435917e+01, -6.283185307179586e+00,
          1.256637061435917e+01, 1.],
        [1., 0.5, 2.*np.pi, 0., 2.*np.pi, 0.],
    ],
    [
        [ 2.304644260117695e-03,  0.000000000000000e+00, 1.720209894426244e-02,
         -1.256637061435917e+01, -6.283185307179586e+00,
          1.884955592153876e+01, 1.],
        [1., 0.5, 2.*np.pi, 0., 2.*np.pi, 2.*np.pi],
    ]
]
