...
class TestFunctions(unittest.TestCase):
    ...
    @parameterized.expand(
        data.secondary_semimajor_axis_from_semimajor_axis
    )
    ...
    @parameterized.expand(
        data.primary_semimajor_axis_from_secondary_semimajor_axis
    )
    ...
    @parameterized.expand(
        data.secondary_semimajor_axis_from_primary_semimajor_axis
    )
...
class TestOrbit(unittest.TestCase):
    ...
    @parameterized.expand(data.initialization)
    ...
    @parameterized.expand(data.radius)
    def test_radius(self, x, target):
        result = self.orbit.radius(x)
        self.assertAlmostEqual(result, target)

    @parameterized.expand(data.speed)
